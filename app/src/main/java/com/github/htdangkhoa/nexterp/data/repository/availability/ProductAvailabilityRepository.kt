...
interface ProductAvailabilityRepository : BaseRepository {
    suspend fun getProductAvailability(searchable: String, location_id: Int, brand_ids: List<Long>?, tag_ids: List<Long>?, bin_ids: List<Long>?, category_ids: List<Long>?, stock_locator_ids: List<Long>?): Result<Array<ProductAvailabilityResponse.ProductAvailability>>
}
