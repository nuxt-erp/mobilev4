...
class ReceivingListAdapter(context: Context?, viewModel: ReceivingViewModel, comparator: Comparator<ReceivingResponse.Receiving>) :
    RecyclerView.Adapter<ReceivingListViewHolder>() {
    ...
    private val mViewModel: ReceivingViewModel = viewModel
    private val mComparator: Comparator<ReceivingResponse.Receiving> = comparator

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ReceivingListViewHolder {
        val binding: ReceivingItemViewHolderBinding = ReceivingItemViewHolderBinding.inflate(
            mInflater,
            parent,
            false
        )
        return ReceivingListViewHolder(binding)
    }

    override fun onBindViewHolder(holder: ReceivingListViewHolder, position: Int) {
